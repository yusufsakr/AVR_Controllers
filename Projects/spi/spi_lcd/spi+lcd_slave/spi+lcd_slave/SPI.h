...
/*
    Function name         :  SPI_master_receive_char
    Function Returns      :  unsigned char
    Function Arguments    :  unsigned char data
    Function Description  :  Master Receive data from Master via SPI.
*/
unsigned char SPI_master_receive_char (unsigned char data);
...
/*
    Function name         :  SPI_slave_send_char
    Function Returns      :  void
    Function Arguments    :  unsigned char *string
    Function Description  :  Send string From Slave to Master via SPI.
*/
unsigned char SPI_slave_send_char (unsigned char data);


/*
    Function name         :  SPI_slave_send_string
    Function Returns      :  void
    Function Arguments    :  unsigned char *string
    Function Description  :  Send string From Slave to Master via SPI.
*/
unsigned char SPI_slave_send_string (unsigned char *string);
